...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard', compact('productcount','orderscount', 'lunassum', 'notlunassum', 'admincount', 'customercount', 'employeecount', 'partnercount', 'messagecount','reviewcount'));
    }
}

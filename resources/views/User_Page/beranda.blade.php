        ...
        <div class="swiper info-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide">
                    ...
                    <h3> </h3>
                    <ul>
                        <li>Jumlah undangan ataupun kendaraan</li>
                        <li>Kapasitas listrik dilokasi pernikahan</li>
                        <li>Penginapan untuk keluarga yang menginap</li>
                    </ul>
                    <p> </p>
                ...
                <div class="swiper-slide slide">
                    ...
                    <p>
                    <ul>
                        <li>Dipesan jauh-jauh hari</li>
                        <li>Sesuaikan dengan tema pernikahan</li>
                    </ul>
                    </p>
                    <p> </p>
